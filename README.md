...
На мій погляд значною перевагою JSTL елемента <c:out> над іншим є захист від XSS атак шляхом екранування. Мінусом же такої ідеї є звісно нагромадження синтаксису а також те що його варто використовувати лише для статичного тексту.
